...
async function selectLevel(id){
  ...
  try{
    ...
    $('preview-panel').querySelector('p').innerHTML=round.leakyPad?'Start at the pad’s lower-right opening. Follow the red arrows into the clothes.<br>Power-ups at 1:33.5–1:52 and 3:06–3:24. Find the pink exit light.':'You start at the green marker. Stickman starts at the pink exit light.<br>Find a kitty if things get a little too close.';
